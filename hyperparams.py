class Hyperparams:
    ...
    # data
    #data = "C:\StartOver\LJSpeech-1.1"
    data = "C:/StartOver/LJSpeech-1.1"
    # data = "/data/private/voice/kate"
    # data = C:\StartOver\LJSpeech-1.1
    test_data = 'C:/StartOver/dc_tts-master/harvard_sentences.txt'
    ...
    logdir = "C:/StartOver/dc_tts-master/logdir/LJ01"
    #restoredir = "C:/StartOver/LJ_logdir/LJ01-1"
    restoredir = "C:\StartOver\dc_tts-master\logdir\LJ01-2"
    sampledir = "C:/StartOver/dc_tts-master/samples"
    B = 8 # batch size
    #B = 25 # batch size
    num_iterations = 748000
    #num_iterations = 8000
